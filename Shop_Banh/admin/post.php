...
if (isset($_GET['id']) && isset($_GET['type'])) {
    $id = $_GET['id'];
    $type = $_GET['type'];
    $stpost = $post->update_status_post($id, $type);
}
?>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                <div class="page-title-actions">
                    <a href="post-create.php" class="btn-shadow btn-hover-shine mr-3 btn btn-primary">
        ...
        <div class="card-body px-0 pb-2">
            <div class="table-responsive p-0">
                ...
                <table class="table align-items-center mb-0">
                    ...
                    <tbody>
                        <?php $show_post = $post->show_post();
                        $i = 0;
                        if ($show_post && $show_post->num_rows > 0) {
                            while ($result = $show_post->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <a href="post-edit.php?id=<?php echo $result['id']; ?>" class="btn bg-gradient-success"
