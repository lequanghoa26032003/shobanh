...
if (isset($_GET['delId'])) {
    $id = $_GET['delId'];
    $delslider = $cat->del_slider($id);
}
if (isset($_GET['id']) && isset($_GET['type'])) {
    $id = $_GET['id'];
    $type = $_GET['type'];
    $delslider = $cat->update_status_slider($id, $type);
}
?>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                <div class="page-title-actions">
                    <a href="slider-create.php" class="btn-shadow btn-hover-shine mr-3 btn btn-primary">
        ...
        <div class="card-body px-0 pb-2">
            <div class="table-responsive p-0">
                ...
                <table class="table align-items-center mb-0">
                    ...
                    <tbody>
                        <?php $show_pd = $cat->show_slider_list();
                        $i = 0;
                        if ($show_pd && $show_pd->num_rows > 0) {
                            while ($result = $show_pd->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm"><?php echo $result['sliderName']; ?>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <img style="height:70px; width:110px;" src="../uploads/<?= $result['sliderImage']; ?>"
                                            alt="<?php echo $result['sliderImage']; ?>">
                                    </td>
                                    ...
                                    <td class="align-middle text-center">
                                        <a href="slider-edit.php?id=<?php echo $result['id']; ?>"
