    ...
    <div class="card my-4">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <span class="text-white text-capitalize ps-3">Danh sách đơn đặt hàng</span>
                <a href="orderhistory.php" class="btn btn-warning float-end"> <i class="fa fa-reply me-1"></i> Lịch sử
                    đơn đặt
                    hàng</a>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <a class="btn bg-gradient-info"
                                            href="order-detail.php?t=<?= $result['tracking_no'] ?>"><i
