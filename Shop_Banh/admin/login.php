              ...
              <div class="card-body">
                ...
                <form action="login.php" method="post" class="text-start">
                  <div class="input-group input-group-outline my-3">
                    <input name="adminEmail" type="email" class="form-control" placeholder="Nhập email">
                  </div>
                  <div class="input-group input-group-outline mb-3">
                    <input name="adminPass" type="password" class="form-control" placeholder="Nhập mật khẩu">
                  </div>
